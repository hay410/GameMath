...
public:
	...
	static float isOldPadThumb(int pad)
	{
		...
		{
		case XINPUT_THUMB_LEFTVERT:
			return (float)oldstate.Gamepad.sThumbLY / (32767);
		case XINPUT_THUMB_LEFTSIDE:
			return (float)oldstate.Gamepad.sThumbLX / 32767;
		case XINPUT_THUMB_RIGHTVERT:
			return (float)oldstate.Gamepad.sThumbRY / 32767;
		case XINPUT_THUMB_RIGHTSIDE:
			return (float)oldstate.Gamepad.sThumbRX / 32767;
		default: return 0;
		}
	}
